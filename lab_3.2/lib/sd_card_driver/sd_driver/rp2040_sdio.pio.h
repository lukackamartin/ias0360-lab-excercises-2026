...
#define CLKDIV 4
#define SDIO_CLK_PIN_D0_OFFSET 18
...
static __pio_const uint16_t sdio_cmd_clk_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program sdio_cmd_clk_program = {
...
static __pio_const uint16_t sdio_data_rx_program_instructions[] = {
            //     .wrap_target
    0xa022, //  0: mov    x, y
    0x2020, //  1: wait   0 pin, 0
    0x23b2, //  2: wait   1 pin, 18              [3]
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program sdio_data_rx_program = {
...
static __pio_const uint16_t sdio_data_tx_program_instructions[] = {
    0x2032, //  0: wait   0 pin, 18
    0x24b2, //  1: wait   1 pin, 18              [4]
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program sdio_data_tx_program = {
